...
const homepage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      {/* Main Content */}
      <div className="flex flex-col pb-20 xl:mb-74 lg:mb-68 mb-10 md:rounded-b-[40px] rounded-b-lg lg:rounded-b-[80px] border border-zinc-400 dark:border-zinc-700 bg-zinc-200/50 dark:bg-zinc-900 shadow-xl">
        <section id="home">
          <Header />
        </section>
